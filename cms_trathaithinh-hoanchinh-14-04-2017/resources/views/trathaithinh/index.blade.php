                                                ...
                                                <div class="thim-widget-gallery thim-widget-gallery-base">
                                                    <div class="wrapper-filter-controls">
                                                        <div class="filter-controls">
                                                            <a class="filter active">NHÀ HÀNG</a>
                                                            <a class="filter" href="javascript:;" data-filter=".filter-gallery-1664">THIỆP CƯỚI</a><a class="filter" href="javascript:;" data-filter=".filter-gallery-1661">HOA CƯỚI</a><a class="filter" href="javascript:;" data-filter=".filter-gallery-1666">STUDIO</a> </div>
                                                    </div>
                ...
                <div class='row'>
                    ...
                    <div class='col-md-4 col-2' >
                        ...
                        <div class='col-2-bottom'>
                            ...
                            <p><a href="<?php echo $contents['url']; ?>">XEM CHI TIẾT</a></p>
                         </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="welcome">
                        ...
                        <p><a href="https://en.wikipedia.org/wiki/Tyler_Florence" target="_blank">XEM CHI TIẾT</a></p>
            ...
            <div class="col-md-10">
                ...
                <div class="menu">
                    ...
                    <div class="line">
                        ...
                        <!-- begin content -->
                        <div class="content">
                            <h2><?php echo $newsId4['name']; ?></h2>
                            <div class="today"><?php echo $newsId4['description']; ?></div>
                        </div>
                        <!-- end content -->
...
<!-- type-5 -->
 <div class='type-2'>
        <div class="container">	 
            ...
            <div class="row r2">
                <div class="col-md-2 col1">
                        ...
                        <h1 title="Avocado Maki"><?php echo $newsId5['name']; ?></h1>
                        <p><?php echo $newsId5['description']; ?></p>
                </div>

                <div class="col-md-2 col2">
                        <img src="images/02.png" width="170" height="180">
                        <h1 title="Spicy Tuna Roll"><?php echo $newsId6['name']; ?></h1>
                        <p><?php echo $newsId6['description']; ?></p>
                </div>

                <div class="col-md-2 col3">
                        <img src="images/3.png" width="170" height="180">
                        <h1 title="Salmon Dragon Roll"><?php echo $newsId7['name']; ?></h1>
                        <p><?php echo $newsId7['description']; ?></p>
                </div>

                <div class="col-md-2 col4">
                        <img src="images/4.png" width="170" height="180">
                        <h1 title="Smoked Salmon and Caviar Sushi"><?php echo $newsId8['name']; ?></h1>
                        <p><?php echo $newsId8['description']; ?></p>
                </div>

                <div class="col-md-2 col5">
                        <img src="images/5.png" width="170" height="180">
                        <h1 title="Vegetarian Futomaki"><?php echo $newsId9['name']; ?></h1>
                        <p><?php echo $newsId9['description']; ?></p>
                </div>

                <div class="col-md-2 col6">
                        <img src="images/6.png" width="170" height="180">
                        <h1 title="Cucumber Maki"><?php echo $newsId10['name']; ?></h1>
                        <p><?php echo $newsId10['description']; ?></p>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <a href="#">
                <span class="end-footer" data-text="View the full menu"><?php echo $newsId11['name']; ?></span>
            </a>
        </div>
        <p2></p2>
        </div>
	...
	<div class="clearfix"></div>	
		...
		<div class="type_12" style="
				background: url( 'images/hoa-cuoi-25.jpg' ) no-repeat ;
                    ...
                    <div class='col-md-6'>
                        <div class='row'>
                            ...
                            <div class='col-md-5 col-1'>
                                <img src="./images/studio_1.png" width="100%">
                            </div>
                            <!--COL 2-->
							...
							<img src="./images/anh2.png">
                                ...
                                <h3 style="text-align: center;"><?php echo $newsId12['name']; ?></h3>
                                <h5 class="today-specials" style="text-align: center;"><?php echo $newsId12['description']; ?></h5>
                                <div class="today-specials-menu">
                                    <h3 class="" title="Cashew Chicken With Stir-Fry Vegetables &amp; Green Salad"><?php echo $newsId14['name']; ?>
                                       
                                    </h3> 
                                    <div class="today-specials-description"><?php echo $newsId14['description']; ?>
                                    </div>
                                </div>
                    ...
                    <div class='col-md-6'>
                        <div class='row'>
							...
							<img src="./images/anh1.png">
                                ...
                                <h3 style="text-align: center;"><?php echo $newsId13['name']; ?></h3>
                                <h5 class="today-specials" style="text-align: center;"><?php echo $newsId13['description']; ?></h5>
                                <p style="text-align: center;"><?php echo $newsId15['description']; ?></p>
                                <h4 style="text-align: center;"><?php echo $newsId15['name']; ?></h4>
                                <h6 style="text-align: center;"><?php echo $newsId16['description']; ?></h6>
                                <p style="text-align: center;">
                                    <a href="#" target="_self" style="font-size: 14px;" class="book-table-button accent1  button-border hover-accent1 ">
                                        <span class="book-table-text" data-text="Book a table!" style="color:#000000"><?php echo $newsId16['name']; ?></span>
                                    </a>
                                </p>
                            ...
                            <div class='col-md-5 col-4'>
                                <img src="./images/studio_2.png" width="100%">
                            </div>
                        </div>
                    </div>
                </div>
