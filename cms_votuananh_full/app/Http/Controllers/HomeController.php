...
class HomeController extends Controller {
    ...
    public function index() {
        ...
        $listBreakfastThong = $responsize->getListBreakfastThong();////THONG
        $listDinnerThong = $responsize->getListDinnerThong();////THONG
        $listDessertThong = $responsize->getListDessertThong();////THONG
    	...
    	$data['date'] = array(
            ...
            'breakfastthong'  => $listBreakfastThong,//THONg
            'dinnerthong'   => $listDinnerThong,//THONg
            'dessertthong'   => $listDessertThong//THONg
    	);
