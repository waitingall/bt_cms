            ...
            <div class='container'>
                <div class='row'>
                    ...
                    <div class='col-md-4 col-1'>
                        <p style="height: 200px"></p>
                        <h4>Cong cu</h4>
                        <p>“Nguoi dau bep chuyen nghiep can mot bo dung cu va thiet bi. nuoi dau bep phai quan tam toi dung cu lam bep cua ho Khi lên kế hoạch cho một thực đơn và hiểu rõ về việc sử dụng và chung.”</p>
                    </div>
                    <!--COL 2-->
                    <div class='col-md-4 col-2'>
                    ...
                    <div class='col-md-4 col-3'>
                        <p style="height: 200px"></p>
                        <h4>thuc an</h4>
                        <p>“chung toi Tạo ra những món ăn mới và sự kết hợp hương vị đem lại cho các đầu bếp và khách hàng của chúng tôi niềm vui là công việc của tôi và tôi thích nó.”</p>
                    </div>
                </div>
            </div>
</div>			
